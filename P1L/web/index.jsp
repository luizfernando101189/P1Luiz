...
<html>
    ...
    <head>
        <%
             ...
             if (disciplinaList == null) {
                ...
                disciplinaList.add(new Disciplina("Estruturas de Dados", "Pilhas, filas, alocação dinâmica, recursividade, listas encadeadas, tabelas de espalhamento e árvores.", 4, 0.0));
                ...
                disciplinaList.add(new Disciplina("Linguagem de Programação", "Variáveis, constantes, operadores e expressões. Comando de desvio. Controle de malhas. Vetores e ponteiros. Funções de biblioteca. Estruturas, uniões e tipos definidos pelo usuário. Manipulação de arquivos.", 4, 0.0));
                ...
                disciplinaList.add(new Disciplina("Inglês III", "Expansão da compreensão e produção oral e escrita por meio de funções sociais e estruturas básicas da língua. Ênfase na oralidade, atendendo às especificidades acadêmico-profissionais da área e abordando aspectos sócio-culturais da língua inglesa.", 4, 0.0));
    ...
    <body>
        <div class="text-center">
            <h1>Luiz Fernando Santos Gomes</h1>
            <h2>RA:1290481912051</h2>
            <h3>Disciplinas Matriculadas:<%=disciplinaList.size()%></h3>
        </div>
    </body>
</html>
